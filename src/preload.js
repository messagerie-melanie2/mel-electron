...
contextBridge.exposeInMainWorld(
    ...
    send: (channel, data) => {
        // whitelist channels
        let validChannels = ["read_mail_dir", "mail_select", "eml_read", "attachment_select", "subfolder", "subfolder_settings", "download_eml", "get_archive_folder", "get_archive_path", "search_list", "read_unread", "flag_unflagged", "stop-archivage", "delete_selected_mail", "import-archivage", "new_archive_path", "create_folder", "delete_folder", "change_archive_path"];
